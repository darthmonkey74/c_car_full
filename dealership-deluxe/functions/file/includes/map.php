...
?>
<p class="gtcdi_desc"><?php _e('The fields on the left are Dealership theme inventory fields. 
The fields on the right are the fields you are uploading from your file. 
Select the mapped field on the right with the corresponding Dealership field on the left. 
...
<table cellspacing="0" class="wp-list-table widefat fixed posts">
	<thead>
	<tr>
    	<th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('Dealership Post Title','language');?></span></th>
...
<table cellspacing="0" class="wp-list-table widefat fixed posts">
	<thead>
	<tr>
    	<th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('Dealership Meta Fields','language');?></span></th>
        <th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('File Import Fields','language');?></span></th>
	</tr>
	</thead>
...
<table cellspacing="0" class="wp-list-table widefat fixed posts">
	<thead>
	<tr>
    	<th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('Dealership Taxonomy','language');?></span></th>
        <th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('File Import Fields','language');?></span></th>
...
<table cellspacing="0" class="wp-list-table widefat fixed posts">
	<thead>
	<tr>
    	<th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('Dealership Photo Gallery','language');?></span></th>
        <th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('File Import Fields','language');?></span></th>
        <th style="" class="manage-column column-title" id="title" scope="col"><span><?php _e('Separator','language');?></span></th>
	</tr>
	</thead>
