<div id="wpbody">
	<div id="wpbody-content" tabindex="0" aria-label="Main content">
		<div class="wrap">
            ...
            <h2><?php _e('Dealership XML-CSV Batch Vehicle Import','language');?></h2>
            <p class="gtcdi_step"><?php _e('Please follow the instructions below to import your existing vehicles into Dealership theme.','language');?></p>
