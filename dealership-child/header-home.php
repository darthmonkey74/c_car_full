...
<div class="header-wrapper">
  <div class="header">
    <div id="tel_no">
       Call 0844 273 3128<br>
       <span>(low rate number)</span>
   </div>
  <a class="hide-for-small" href="<?php bloginfo('url'); ?>"> <img class="logo" src="<?php header_image(); ?>" alt="<?php bloginfo('name'); ?>" /> </a>
    <div class="nav-panel hide-for-small">
      <?php wp_nav_menu( array( 'theme_location' => 'header-menu','container' => false,'menu_class'=>'main-nav')); ?>
    </div>
    <div style="clear"></div>
        <?php if ( ! dynamic_sidebar('Carousel Cars')) : ?>
		<?php endif; ?>
	</div>  	
